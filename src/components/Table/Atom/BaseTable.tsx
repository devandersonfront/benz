...
export default function CustomizableRenderers({ direction }: any) {
  ...
  return (
    <GridWrapper>
      <DataGrid
        ...
        // renderers={{ renderSortStatus, renderCheckbox } as any}
        direction={direction}
        headerRowHeight={44}
        rowHeight={80}
      />
...
function renderCheckbox({ onChange, ...props }: any) {
...
function renderSortStatus({ sortDirection, priority }: any) {
  return (
    <>
